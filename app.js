...
function homePage() {
  ...
  return header("home", false) +
    "<main id='conteudo'>" +
      ...
      "<section class='section home-equipment-section'><div class='container'><div class='section-heading'><div><span class='eyebrow'>Nova biblioteca digital</span><h2>Novos pontos de partida para construir seu timbre.</h2></div><p>Essentials, seleções por estilo e guias práticos. Produtos paralelos aos packs completos.</p></div><div class='home-equipment-grid'><a href='/novos-produtos/'><span>01</span><h3>M-VAVE Essentials</h3><p>Curadorias compactas para guitarra, baixo e violão.</p></a><a href='/styles/modern-rock/'><span>02</span><h3>Packs por estilo</h3><p>Modern Rock e Post Grunge, validados pelo acervo.</p></a><a href='/mapa-dos-timbres/'><span>03</span><h3>Guias de timbre</h3><p>Mapa visual e receitas práticas para deixar de começar do zero.</p></a></div></div></section>" +
